...
//  ********** Library C:\Users\Saransh\dart\Snakes\Snakes **************
// ********** Code for top level **************
var bonusx;
var bonusy;
var ctx;
function draw() {
  $globals.ctx.clearRect((0), (0), (450), (300));
  $globals.ctx.fillStyle = "#FF0000";
  $globals.ctx.fillRect($globals.posx * (10), $globals.posy * (10), (10), (10));
  $globals.ctx.fillStyle = "#FFFF00";
  $globals.ctx.fillRect($globals.bonusx * (10), $globals.bonusy * (10), (10), (10));
  var ms = get$$document().query("#msg");
  ms.set$innerHTML($add$("SCORE: ", $globals.score.toString()));
}
function func() {
  switch ($globals.flag) {
    case (1):
  ...
  if ((($globals.posx == $globals.bonusx && $globals.posy == $globals.bonusy)) && $globals.fl == (0)) {
    $globals.bonusx = ($mod$((Math.random() * (100)).floor(), (46)));
    $globals.bonusy = $mod$((Math.random() * (100)).floor(), (31));
    $globals.score = $globals.score + (10);
    $globals.x = $globals.x + (5);
  }
  if ($globals.posx < (0) || $globals.posx >= (46) || $globals.posy < (0) || $globals.posy >= (31)) {
    var msg_score = get$$document().query("#msg");
    $globals.fl = (1);
    msg_score.set$innerHTML($add$("Thank you for playing the game.<br /> Your Score : <b>" + $globals.score, "</b><br /><br /><input type='button' value='Play Again' id='play' />"));
    get$$document().query("#play").get$on().get$click().add$1((function (e) {
      print$("hi");
    })
    );
    get$$document().query("#playArea").style.set$display("none");
    get$$window().clearInterval($globals.value);
  }
}
var value;
function main() {
  var canvas = get$$document().query("#playArea");
  $globals.ctx = canvas.getContext("2d");
  $globals.bonusx = ($mod$((Math.random() * (100)).floor(), (46)));
  $globals.bonusy = $mod$((Math.random() * (100)).floor(), (31));
  $globals.value = get$$window().setInterval(func, (30) - $globals.x);
  if ($globals.fl == (0)) {
    get$$document().get$on().get$keyDown().add((function (e) {
      var ke = e;
...
(function(){
  ...
  var table = [
    ...
    , ['Node', [v1/*HTMLDocument*/,v2/*DocumentFragment*/,v3/*Element*/,'Node|Attr|CharacterData|Comment|Text|CDATASection|DocumentType|Entity|EntityReference|Notation|ProcessingInstruction'].join('|')]
...
var const$0007 = Object.create(EmptyQueueException.prototype, {});
var const$0008 = Object.create(UnsupportedOperationException.prototype, {_message: {"value": "", writeable: false}});
var $globals = {};
$static_init();
